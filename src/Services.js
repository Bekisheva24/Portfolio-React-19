	...
	return (
		<div className='service component__space' id="Services">
			...
			<div className="heading">
				<h1 className="heading">My Awesome Service
				</h1>
			...
			<div className="row">
					...
					<div className="service__box pointer">
						...
						<div className="service__meta">
							...
							<p className="service__text p__color">
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi ipsum modi culpa possimus?
							</p>
						</div>
					</div>
				</div>
				...
				<div className="col__3">
					<div className="service__box pointer">
						...
						<div className="service__meta">
							<h1 className="service__text">Marketing & Reporting
							</h1>
							<p className="service__text p__color">
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi ipsum modi culpa possimus?
							</p>
